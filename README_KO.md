...
이 확장은 비공식 확장이며 OpenAI·Anthropic과 관련이 없습니다.
...
- 팝업에서 ChatGPT와 Claude 자동 적용을 각각 켜고 끌 수 있습니다(서로 독립).
- Chrome sync storage에는 사용자의 사이트별 켜기/끄기 설정만 저장합니다.
...
1. [Releases](https://github.com/HanChangHun/temporary-chat-auto/releases)에서 최신 store package를 내려받습니다.
2. zip 파일의 압축을 풉니다.
...
- ChatGPT 새 채팅 화면에서 Temporary Chat 토글이 보이고 꺼진 상태가 명확할 때만 켭니다.
- 팝업과 화면 안의 작은 토글은 같은 사이트별 설정을 제어하며, ChatGPT와 Claude 설정은 서로 독립입니다.
